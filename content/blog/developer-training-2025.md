...
date: 2025-01-22
author: "Andreas Ebner, Noel Graf, Florian Düwel"
...
1. **Day 1**: Basics of OPC UA, information modeling and security concepts.
2. **Day 2**: Practical application of open62541 for client- and server development.
3. **Day 3**: Advanced mechanisms using pubsub and event handling.
...
**🔗 Sign up now**: [https://www.iosb.fraunhofer.de/opcua-workshop](https://www.iosb.fraunhofer.de/opcua-workshop)

**👉 Questions?** Contact us via [Email](mailto:andreas.ebner@iosb.fraunhofer.de)

---

*Contact: [Andreas Ebner](mailto:andreas.ebner@iosb.fraunhofer.de), [Noel Graf](mailto:noel.graf@iosb.fraunhofer.de), [Florian Düwel](mailto:florian.duewel@iosb.fraunhofer.de)*

...
> **Note:** The v1.3 release family contains new features compared to v1.0. These have not been part of the certification that was achieved for the example server based on the v1.0 release.

Older releases and release notes can be found here: [https://github.com/open62541/open62541/releases](https://github.com/open62541/open62541/releases)

[**Download open62541 v1.3 from GitHub**](https://github.com/open62541/open62541/releases/tag/v1.3)
